...
namespace Windows7.Multitouch.Window
{
    /// <summary>
    ...
    class ControlWrapper : IHwndWrapper
    {
        ...
        public ControlWrapper(System.Windows.Forms.Control control)
        {
    ...
    /// </summary>
    public class GUITimer : System.Windows.Forms.Timer, IGUITimer
    {
    }
    ...
    public class Factory
    {
        ...
        public static T CreateHandler<T>(System.Windows.Forms.Control control) where T : Windows7.Multitouch.Handler
        {
