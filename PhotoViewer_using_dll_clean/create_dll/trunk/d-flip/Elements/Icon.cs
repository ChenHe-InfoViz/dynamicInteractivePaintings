...
namespace dflip.Element
{
    public class Icon
    {
        ...
        public void Render(SpriteBatch batch, Texture2D texture1, Color iconColor)
        {
            //if (texture_ != null)
            {
                batch.Draw(ResourceManager.texture_[iconID_], position_, null, iconColor, 0f, center_, scale_, SpriteEffects.None, 0f);
            }
            ...
            if (tooltip.IsDel == false)
            {
                ...
                tooltip.Render(SystemParameter.batch_, ResourceManager.font_, ResourceManager.fukiTex_);
